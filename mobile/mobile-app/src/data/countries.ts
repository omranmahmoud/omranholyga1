// Basic country dataset (subset). Extend as needed.
export interface CountryItem {
  code: string; // ISO 3166-1 alpha-2
  name: string; // Common English fallback name
  dial: string; // E.164 dial code (primary)
  aliases?: string[]; // Optional alternative names / spellings / local names
  t?: string; // optional translation key path suffix (countries.<code>)
}

// NOTE: Minimal dependency approach; static list. If you ever want to slim bundle size,
// you can lazy-load this list or move to a backend endpoint.
export const COUNTRIES: CountryItem[] = [
  ...
  { code: 'CG', name: 'Congo - Brazzaville', dial: '+242', aliases: ['Republic of the Congo'] },
  { code: 'CD', name: 'Congo - Kinshasa', dial: '+243', aliases: ['DRC','Democratic Republic of the Congo'] },
  { code: 'CR', name: 'Costa Rica', dial: '+506' },
  { code: 'CI', name: 'Côte d’Ivoire', dial: '+225', aliases: ['Ivory Coast','Cote dIvoire'] },
  { code: 'HR', name: 'Croatia', dial: '+385' },
  { code: 'CU', name: 'Cuba', dial: '+53' },
  { code: 'CY', name: 'Cyprus', dial: '+357' },
  { code: 'CZ', name: 'Czechia', dial: '+420', aliases: ['Czech Republic'] },
  { code: 'DK', name: 'Denmark', dial: '+45' },
  { code: 'DJ', name: 'Djibouti', dial: '+253' },
  { code: 'DM', name: 'Dominica', dial: '+1767' },
  { code: 'DO', name: 'Dominican Republic', dial: '+1', aliases: ['Dominican Republic (1)'] },
  ...
  { code: 'SZ', name: 'Eswatini', dial: '+268', aliases: ['Swaziland'] },
  ...
  { code: 'MM', name: 'Myanmar', dial: '+95', aliases: ['Burma'] },
  ...
  { code: 'MK', name: 'North Macedonia', dial: '+389', aliases: ['Macedonia'] },
  { code: 'MP', name: 'Northern Mariana Islands', dial: '+1670' },
  { code: 'NO', name: 'Norway', dial: '+47' },
  { code: 'OM', name: 'Oman', dial: '+968' },
  { code: 'PK', name: 'Pakistan', dial: '+92' },
  { code: 'PW', name: 'Palau', dial: '+680' },
  { code: 'PS', name: 'Palestine', dial: '+970', aliases: ['Palestinian Territories','West Bank','Gaza','State of Palestine'], t: 'countries.PS' },
  ...
  { code: 'BL', name: 'Saint Barthélemy', dial: '+590', aliases: ['Saint Barthelemy'] },
  ...
  { code: 'ST', name: 'São Tomé and Príncipe', dial: '+239', aliases: ['Sao Tome and Principe'] },
  ...
  { code: 'KR', name: 'South Korea', dial: '+82', aliases: ['Korea Republic of'] },
  ...
  { code: 'TL', name: 'Timor-Leste', dial: '+670', aliases: ['East Timor'] },
  ...
  { code: 'GB', name: 'United Kingdom', dial: '+44', aliases: ['UK','Great Britain'] },
  { code: 'US', name: 'United States', dial: '+1', aliases: ['USA','United States of America'] },
  { code: 'UY', name: 'Uruguay', dial: '+598' },
  { code: 'UZ', name: 'Uzbekistan', dial: '+998' },
  { code: 'VU', name: 'Vanuatu', dial: '+678' },
  { code: 'VA', name: 'Vatican City', dial: '+379', aliases: ['Holy See'] },
  { code: 'VE', name: 'Venezuela', dial: '+58' },
  { code: 'VN', name: 'Vietnam', dial: '+84' },
  { code: 'VI', name: 'U.S. Virgin Islands', dial: '+1340' },
  { code: 'WF', name: 'Wallis and Futuna', dial: '+681' },
  { code: 'EH', name: 'Western Sahara', dial: '+212', aliases: ['Sahrawi'] },
